                            ...
                            <div class="product-thumbs">
                                <carousel  :dots="false" :nav="false" class="product-thumbs-track ps-slider">
                                    <div class="pt" @click="changeImage(thumbs[0])" :class="thumbs[0] == gambar_default ? 'active' : '' ">
                                        <img src="img/mtb/bracket/sdeore/PistonResinpad.jpeg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(thumbs[1])" :class="thumbs[1] == gambar_default ? 'active' : '' ">
                                        <img src="img/mtb/bracket/sdeore/PistonResinpad2.jpeg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(thumbs[2])" :class="thumbs[2] == gambar_default ? 'active' : '' ">
                                        <img src="img/mtb/bracket/sdeore/PistonResinpad3.jpeg" alt="" />
                                    </div>
                                </carousel>
                            </div>
                        </div>
...
import HeaderSpartShop from "@/components/HeaderSpartShop.vue";
import FooterSpartShop from "@/components/FooterSpartShop.vue";
import RelatedSpartShop from "@/components/RelatedSpartShop.vue";
...
export default {
  ...
  components: {
    ...
    data() {
        return {
            gambar_default: "img/mtb/bracket/sdeore/PistonResinpad.jpeg",
            thumbs: [
                "img/mtb/bracket/sdeore/PistonResinpad.jpeg",
                "img/mtb/bracket/sdeore/PistonResinpad2.jpeg",
                "img/mtb/bracket/sdeore/PistonResinpad3.jpeg"
            ]
        }
    },
    methods: {
